...
;of results
pro orbital_vf_ta15b, name

  get_data, name, data = d

  tta15b,name,pdyn=2.0D,yimf=0.0D,zimf=-5.0D,xind=1.5D,error=e

  get_data, name+'_bta15b', data = td
  ...
  proj_pos = project_ta15b([vp1, vp2], d.y)

  proj_mag = project_ta15b([vp1, vp2], td.y)
...
tta15b, 'thb_state_pos',pdyn=2.0D,yimf=0.0D,zimf=-5.0D,xind=1.5D,error=e
...
tplot,'thb_state_pos_bta15b'

stop

del_data,'thb_state_pos_bta15b'
...
tta15b, 'thb_state_pos',pdyn=replicate(2.0D,n),yimf=replicate(0.0D,n),zimf=replicate(-5.0D,n),xind=replicate(1.5D,n),error=e
...
tta15b,'thb_state_pos',pdyn='t_pdyn',yimf='t_yimf',zimf='t_zimf',xind='t_xind',error=e
...
;test with newname
tta15b, 'thb_state_pos',pdyn=2.0D,yimf=0.0D,zimf=-5.0D,xind=1.5D,newname='test',error=e
...
tta15b, 'thb_state_pos',pdyn=2.0D,yimf=0.0D,zimf=-5.0D,xind=1.5D,period=30,error=e
...
tta15b, 'thb_state_pos',pdyn=2.0D,yimf=0.0D,zimf=-5.0D,xind=1.5D,period=30,error=e,get_tilt='tilt_vals',get_nperiod=gn,add_tilt=1
...
tta15b, 'thb_state_pos',pdyn=2.0D,yimf=0.0D,zimf=-5.0D,xind=1.5D,period=30,error=e,get_tilt='tilt_vals',get_nperiod=gn,set_tilt=1
...
orbital_vf_ta15b,'thb_state_pos'

print,'The plot produced should look like the plot titled ta15b_test.png'
