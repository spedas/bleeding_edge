...
; SVN Properties
; --------------
; $LastChangedRevision: 31610 $
; $LastChangedDate: 2023-03-09 13:20:37 -0800 (Thu, 09 Mar 2023) $
; $LastChangedBy: rlivi04 $
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/SPP/sweap/SPAN/ion/spp_swp_spi_config_flight_high_rate_cruise_moments.pro $
;-


PRO spp_swp_spi_config_flight_high_rate_cruise_moments, mem, info
   ...
   FOR i = 0, 23 DO BEGIN 
      CASE prod_type[i] OF
         ...
         '08Dx32Ex08A':BEGIN
            ...
            str_addr[i+1] = str_addr[i]+pmbins[i]*ed_length[i]
         END
         '08Dx32Ex08A_v2':BEGIN
            ed_length  = [ed_length, mem.prod_08Dx32Ex08A_dpp_size]
            str_addr[i+1] = str_addr[i]+pmbins[i]*ed_length[i]
         END
         '08Dx32Ex08A_v3':BEGIN
            ed_length  = [ed_length, mem.prod_08Dx32Ex08A_dpp_size]
            str_addr[i+1] = str_addr[i]+pmbins[i]*ed_length[i]
         END
         '08Dx32Ex16A':BEGIN 
