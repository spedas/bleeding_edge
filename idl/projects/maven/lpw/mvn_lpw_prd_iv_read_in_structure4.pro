pro mvn_lpw_prd_iv_read_in_structure4,dir_name,boom
...
;;  stanna
 ...
 ; help,fitstruc.lpstruc.ree04.val,/st
  store_data,'ree_Vsc'+st,data={x:fitstruc.lpstruc.time,y:-1.0*[[fitstruc.lpstruc.ree04.val.Vsc],[fitstruc.lpstruc.ree04.val.Vsc+fitstruc.lpstruc.ree04.err.vsc],[fitstruc.lpstruc.ree04.val.Vsc-fitstruc.lpstruc.ree04.err.vsc]]}
  options,'ree_Vsc'+st,colors=[6,4,4]
 
; stanna
 flag= 1.0/(fitstruc.lpstruc.ree04.val.erra LT 100)
 corr=1.0/(fitstruc.lpstruc.ree04.val.Vsc NE 0)
 dVsc=1.0*0.2  ;fitstruc.lpstruc.ree04.val.Vsc

  store_data,'ree_Vsc'+st ,data={x:fitstruc.lpstruc.time,y:  -1.0*[[fitstruc.lpstruc.ree04.val.Vsc*corr], $
                                                                   [(fitstruc.lpstruc.ree04.val.Vsc-dVsc)*corr],  $
                                                                   [(fitstruc.lpstruc.ree04.val.Vsc+dVsc)*corr]]}
  store_data,'ree_Vscn'+st,data={x:fitstruc.lpstruc.time,y:  -1.0*flag*fitstruc.lpstruc.ree04.val.Vsc} ; this is flipped sign so Iit can be compared with the IV data
 
 ;dNe=abs(fitstruc.lpstruc.ree04.val.n*0.3) ;fitstruc.lpstruc.ree04.err.n
 ; store_data,'ree_Ne'+st  ,data={x:fitstruc.lpstruc.time,y:   1e-6*[[fitstruc.lpstruc.ree04.val.n*corr],   $
 ;                                                                   [fitstruc.lpstruc.ree04.val.n  -dNe*corr], $
 ;                                                                   [fitstruc.lpstruc.ree04.val.n  +dNe*corr]] }
 
 
 store_data,'ree_Ne'+st  ,data={x:fitstruc.lpstruc.time,y:    1e-6*[[fitstruc.lpstruc.ree04.val.n*corr],   $
                                                                    [fitstruc.lpstruc.ree04.errc.n[0]*corr], $
                                                                    [fitstruc.lpstruc.ree04.errc.n[1]*corr]] }

 
 
  store_data,'ree_Nen'+st ,data={x:fitstruc.lpstruc.time,y:   1e-6*flag*fitstruc.lpstruc.ree04.val.n} 
 
 ; not used dTe= abs(fitstruc.lpstruc.ree04.err.Te)
 ; store_data,'ree_Te'+st  ,data={x:fitstruc.lpstruc.time,y:     [[ fitstruc.lpstruc.ree04.val.Te],  $
 ;                                                                [ fitstruc.lpstruc.ree04.err.telow], $
 ;                                                                [ fitstruc.lpstruc.ree04.err.teupp]] }

store_data,'ree_Te'+st  ,data={x:fitstruc.lpstruc.time,y:     [[ fitstruc.lpstruc.ree04.val.Te],  $
                                                                 [ fitstruc.lpstruc.ree04.errc.te[0]], $  ; lower value
                                                                 [ fitstruc.lpstruc.ree04.errc.te[1]]] }  ;upper valua

 ; store_data,'ree_Ten'+st ,data={x:fitstruc.lpstruc.time,y:          flag* fitstruc.lpstruc.ree04.val.Te } 
  
  
  ; store_data,'ree_Tpoints'+st ,data={x:fitstruc.lpstruc.time,y: fitstruc.lpstruc.ree04.err.nptte }

   store_data,'ree_Tpoints'+st ,data={x:fitstruc.lpstruc.time,y: Fitstruc.lpstruc.ree04.errc.Te}

  
;for struvture04

;   For Ne:
;   Fitstruc.lpstruc.ree04.val.N
;   Fitstruc.lpstruc.ree04.errc.N   ;upper and lower values

 ;  For Te:
 ;  Fitstruc.lpstruc.ree04.val.Te
 ;  Fitstruc.lpstruc.ree04.errc.Te  ;upper and lower values




 ; stanna
  ; fitstruc.lpstruc.ree04.err.Teupp   - actualvalues
  ; fitstruc.lpstruc.ree04.err.Telow - actualvalues
  ; fitstruc.lpstruc.ree04.val.Te - actualvalues
  ; fitstruc.lpstruc.ree04.err.nptste  - number of points in the fit
  
  
 ; store_data,'ree_ti'+st ,data={x:fitstruc.lpstruc.time,y :    [[fitstruc.lpstruc.ree04.val.ti], [fitstruc.lpstruc.ree04.val.ti +fitstruc.lpstruc.ree04.err.ti], [(fitstruc.lpstruc.ree04.val.ti -fitstruc.lpstruc.ree04.err.ti)>0.01]]}
 ; store_data,'ree_mi'+st ,data={x:fitstruc.lpstruc.time,y :1.0/1.67e-27*  fitstruc.lpstruc.ree04.val.mi } ;], [fitstruc.lpstruc.ree04.val.mi +fitstruc.lpstruc.ree04.err.mi], [fitstruc.lpstruc.ree04.val.mi -fitstruc.lpstruc.ree04.err.mi]]}
 ; store_data,'ree_ni'+st ,data={x:fitstruc.lpstruc.time,y :        fitstruc.lpstruc.ree04.val.n}
 ; store_data,'ree_ramv'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.ramv}
 ; store_data,'ree_rama'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.rama}
 ; store_data,'ree_fov'+st ,data={x:fitstruc.lpstruc.time,y :       fitstruc.lpstruc.ree04.val.fov}
 ; store_data,'ree_alpha'+st ,data={x:fitstruc.lpstruc.time,y :     fitstruc.lpstruc.ree04.val.alpha}
 ; store_data,'ree_nhot'+st ,data={x:fitstruc.lpstruc.time,y :       1e-6* fitstruc.lpstruc.ree04.val.nhot}
 ; store_data,'ree_thot'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.thot}
 ; store_data,'ree_nspe'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.nspe}
 ; store_data,'ree_tspe'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.tspe}
 ; store_data,'ree_jphe'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.jphe}
...
; max(data.isweep) > 1e-6  for the error
  store_data,'ree_erra'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.erra}  ; s+500*tmp}   ;is this fit quality??
 
  store_data,'ree_sucsess'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.err.success1+fitstruc.lpstruc.ree04.err.success2}  ; s+500*tmp}   ;is this fit quality??
 ...
 ;valid1[*]   <= fitstruc.lpstruc.ree04.val.valid
  store_data,'ree_valid'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.valid}

 
  ;store_data,'ree_uvi'+st ,data={x:fitstruc.lpstruc.time,y :      fitstruc.lpstruc.ree04.val.uvi}   ;is this fit quality??
