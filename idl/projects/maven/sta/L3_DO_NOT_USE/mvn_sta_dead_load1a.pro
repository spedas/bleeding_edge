...
;			18/07/10	minor change - added indbk9_ab,indbk9_fq,indbk9_cd to calculate efficiency background
;NOTES:	  
...
;	Efficiency Background subtraction may be less accurate during protect mode due to less channels with low flux at low energy 
;
;TBDs
...
;		indbk9 = sort(mvn_d9_dat.rates[ind_d9,11,*])
		indbk9_ab = sort(mvn_d9_dat.rates[ind_d9,10,*])
		indbk9_cd = sort(mvn_d9_dat.rates[ind_d9,11,*])
		indbk9_fq = sort(mvn_d9_dat.rates[ind_d9,7,*])
...
; modified to use indbk9_ab, indbk9_fq in addition to indbk9_cd
		ab_bk = total(mvn_d9_dat.rates[ind_d9,10,indbk9_ab[0:9]])/10. > 25.
		cd_bk = total(mvn_d9_dat.rates[ind_d9,11,indbk9_cd[0:9]])/10. > 90.
	endelse
		fq_bk = total(mvn_d9_dat.rates[ind_d9,7,indbk9_fq[0:9]])/10. > 0.
