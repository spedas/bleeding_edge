;+
;PROCEDURE:	mvn_sta_get_c6_co2_avg
;PURPOSE:	
...
;-
FUNCTION mvn_sta_get_c6_co2_avg,time,START=st,EN=en,ADVANCE=adv,RETREAT=ret,index=ind,calib=calib,times=times

common mvn_c6_avg,get_ind,all_dat
...
;	else tmpmin = min(abs((all_dat.time+all_dat.end_time)/2.-time),ind)
...
;	mass_scale=7.5 & cnts_scale=0.99 & ms1=29.2 & ms2=37.9			; testing 20181212, on 20180526 data
;	mass_scale=7.5 & cnts_scale=0.55 & ms1=29.2 & ms2=37.9			; testing 20181212, on 20180526 data
	...
	bkg1 = (total(dat.cnts[*,ind32],2)#replicate(1.,64)/cnts_scale)*(dat.mass_arr ge ms3 and dat.mass_arr le ms4 )*exp(-dat.mass_arr/mass_scale)*dat.twt_arr 
