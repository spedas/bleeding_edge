...
if time_double(time) gt time_double('2014-12-03/00:00') and kk3_anode then kk3 = [0.0,0.0,0.0,0.0]		;**sta o2+ ok, sza=101, alt=164, kk3[3]sta>ngii, checked 20241031, 2 ngims

if time_double(time) gt time_double('2014-12-05/00:00') and kk3_anode then kk3 = [0.0,0.0,0.0,0.0]		;**sta o2+ ok, sza=104, alt=165, kk3[3]sta>ngi, checked 20241031, 2 ngims

if time_double(time) gt time_double('2014-12-14/00:00') and kk3_anode then kk3 = [0.0,0.0,0.0,0.0]		;**sta o2+ ok, sza=117, alt=154, kk3[3]sta>ngi, checked 20241031, 2 ngims

if time_double(time) gt time_double('2014-12-23/00:00') and kk3_anode then kk3 = [1.5,1.5,1.5,0.0]		;
if time_double(time) gt time_double('2014-12-23/00:00') and kk3_anode then kk3 = [0.0,0.0,0.0,0.0]		;**sta o2+ ok, sza=126, alt=153, kk3[3]sta>ngi, checked 20241104, 3 ngims

if time_double(time) gt time_double('2014-12-31/00:00') and kk3_anode then kk3 = [1.5,1.5,1.5,0.0]		;**sta o2+ ok, sza=134, alt=152, kk3[3]sta>ngi, checked 20241104, 3 ngims

;if time_double(time) gt time_double('2015-01-08/00:00') and kk3_anode then kk3 = [2.7,2.5,2.6,2.0]		; 
if time_double(time) gt time_double('2015-01-08/00:00') and kk3_anode then kk3 = [2.6,2.4,2.5,2.0]		;**sta o2+ ok, sza=138, alt=145, att=1-2, checked 20241031, 2 ngims

if time_double(time) gt time_double('2015-01-15/00:00') and kk3_anode then kk3 = [2.6,2.4,2.5,2.0]		;
if time_double(time) gt time_double('2015-01-15/00:00') and kk3_anode then kk3 = [2.8,2.6,2.7,2.2]		;**sta o2+ ok, sza=138, alt=154, att=1-2, checked 20241103, 2 ngims

if time_double(time) gt time_double('2015-01-16/00:00') and kk3_anode then kk3 = [2.9,2.7,2.8,2.3]		;tbd guess**sta o2+ ok, sza=138, alt=154, att=1-2, checked 20241103, 2 ngims
if time_double(time) gt time_double('2015-01-17/00:00') and kk3_anode then kk3 = [3.0,2.8,2.9,2.4]		;tbd guess**sta o2+ ok, sza=138, alt=154, att=1-2, checked 20241103, 2 ngims

if time_double(time) gt time_double('2015-01-18/00:00') and kk3_anode then kk3 = [3.1,2.9,3.0,2.5]		;**sta o2+ ok, sza=137, alt=154, att=1-2, checked 20241103, 2 ngims

if time_double(time) gt time_double('2015-01-19/00:00') and kk3_anode then kk3 = [3.2,3.0,3.1,2.6]		;guess tbd **sta o2+ ok, sza=138, alt=154, att=1-2, checked 20241103, 2 ngims

;if time_double(time) gt time_double('2015-01-21/00:00') and kk3_anode then kk3 = [2.6,2.4,2.5,2.0]		;
;if time_double(time) gt time_double('2015-01-21/00:00') and kk3_anode then kk3 = [3.1,2.9,3.0,2.5]		;
if time_double(time) gt time_double('2015-01-21/00:00') and kk3_anode then kk3 = [3.3,3.1,3.2,2.7]		;**sta o2+ ok, sza=136, alt=153, att=2, checked 20241103, 1 ngims

if time_double(time) gt time_double('2015-01-22/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,2.9]		;tbd**sta o2+ ok, sza=136, alt=153, att=1-2, checked 20241103, 2 ngims
if time_double(time) gt time_double('2015-01-23/00:00') and kk3_anode then kk3 = [3.7,3.3,3.6,3.1]		;tbd**sta o2+ ok, sza=136, alt=153, att=1-2, checked 20241103, 2 ngims

;if time_double(time) gt time_double('2015-01-24/00:00') and kk3_anode then kk3 = [3.9,3.6,3.8,3.3]		;
if time_double(time) gt time_double('2015-01-24/00:00') and kk3_anode then kk3 = [3.9,3.4,3.8,3.3]		;sta o2+ ok, sza=132, alt=152, att=1-2, checked 20241103, 3 ngims

;if time_double(time) gt time_double('2015-01-25/00:00') and kk3_anode then kk3 = [3.4,3.2,3.3,2.8]		;
;if time_double(time) gt time_double('2015-01-25/00:00') and kk3_anode then kk3 = [4.1,3.9,4.0,3.5]		;
if time_double(time) gt time_double('2015-01-25/00:00') and kk3_anode then kk3 = [4.1,3.8,4.0,3.5]		;**sta o2+ ok, sza=133, alt=152, att=1-2, checked 20241103, 2 ngims

	; No NGIMS data 20150127-20150202  NGIMS data suspect prior to this time due to Florine contamination 

;if time_double(time) gt time_double('2015-02-03/00:00') and kk3_anode then kk3 = [4.4,4.2,4.3,3.8]		;
;if time_double(time) gt time_double('2015-02-03/00:00') and kk3_anode then kk3 = [4.0,3.8,3.9,3.4]		;
if time_double(time) gt time_double('2015-02-03/00:00') and kk3_anode then kk3 = [4.0,3.6,3.9,3.4]		;**sta o2+ ok, sza=122, alt=159, att=1-2, checked 20241103, 3 ngims

if time_double(time) gt time_double('2015-02-04/00:00') and kk3_anode then kk3 = [4.1,3.6,4.0,3.5]		;**sta o2+ ok, sza=122, alt=159, att=1-2, checked 20241104, 1 ngims

if time_double(time) gt time_double('2015-02-05/00:00') and kk3_anode then kk3 = [4.3,3.7,4.2,3.6]		;**sta o2+ ok, sza=121, alt=158, att=1-2, checked 20241104, 2 ngims

if time_double(time) gt time_double('2015-02-06/00:00') and kk3_anode then kk3 = [4.4,4.0,4.3,3.8]		;
if time_double(time) gt time_double('2015-02-06/00:00') and kk3_anode then kk3 = [4.5,3.8,4.3,3.7]		;**sta o2+ ok, sza=119, alt=158, att=1-2, checked 20241103, 3 ngims



;if time_double(time) gt time_double('2015-02-09/00:00') and kk3_anode then kk3 = [4.3,4.1,4.2,3.7]		;
;if time_double(time) gt time_double('2015-02-09/00:00') and kk3_anode then kk3 = [4.6,4.4,4.5,4.0]		;
;if time_double(time) gt time_double('2015-02-09/00:00') and kk3_anode then kk3 = [4.7,4.5,4.6,4.1]		;
if time_double(time) gt time_double('2015-02-09/00:00') and kk3_anode then kk3 = [4.7,4.2,4.6,4.1]		;**sta o2+ ok, sza=137, alt=145, sta_Ni>ngi_Ni, checked 20241031, 2 ngims

	; kk3 gets so large after the deep dip that calibration becomes impossible unless s/c potential is at least -2V
	; the best that can be done is comparison of peak density of ngi and sta on alternate orbits when in alternating flyY-SunVel starting 20150219
	; the above only gives a kk3 value for att=3, so use attenuator transitions to guestimate other attenuator values (even orbits) or use the flanks on odd orbits

if time_double(time) gt time_double('2015-02-11/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,4.6]		; this is a WAG - kk3 probably changing orbit by orbit.

	; kk3 corrections are so large during deep dip 1 that it is unwise to assume these corrections work
	; 20150211 	start deep dip 1

if time_double(time) gt time_double('2015-02-12/00:00') and kk3_anode then kk3 = [6.2,5.7,6.1,5.6]		;WAG assume ion suppression happens quickly and saturates2

	; 20150218 	end deep dip 1

if time_double(time) gt time_double('2015-02-18/00:00') and kk3_anode then kk3 = [6.2,5.7,6.1,5.6]		;WAG assume linear extrapolation from 20150222
if time_double(time) gt time_double('2015-02-19/00:00') and kk3_anode then kk3 = [6.1,5.6,6.0,5.5]		;WAG assume linear extrapolation from 20150222
if time_double(time) gt time_double('2015-02-20/00:00') and kk3_anode then kk3 = [6.0,5.5,5.9,5.4]		;WAG assume linear extrapolation from 20150222
if time_double(time) gt time_double('2015-02-21/00:00') and kk3_anode then kk3 = [5.9,5.4,5.8,5.3]		;WAG assume linear extrapolation from 20150222

	; No NGIMS data 20150218-20150220
	; 20150219 Scenario 1, Alternating flyY SunVel s/c attitude changes s/c potential from -2.5V (even orbits) to ~0 (odd orbits),  ngims only on odd orbits
	; 20150221	MCP voltage increased 2700V->2870V, 0504UT
	; 20150221	NGIMS data available again
	; 20150222	lpw fp data is available as periapsis moves to dayside. Use even orbits with flyY to get kk3[3], and attenuator transitions for kk3[0-2]
	; 	flyY has enough s/c charging to allow STATIC density estimate with fp, however no NGIMS data on those even orbits 
	; 	If lpw fp is unavailable, compare peak densities of ngims (odd orbit) with STATIC (even orbits) for kk3[3]
	;	to estimate kk3[0-2], use ngi/sta ratio on flanks of odd orbits or attenuator transitions on even orbits

;if time_double(time) gt time_double('2015-02-22/00:00') and kk3_anode then kk3 = [6.4,5.1,6.3,5.0]		;
;if time_double(time) gt time_double('2015-02-22/00:00') and kk3_anode then kk3 = [5.9,4.7,5.8,4.6]		; 
;if time_double(time) gt time_double('2015-02-22/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,5.0]		;
;if time_double(time) gt time_double('2015-02-22/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,4.6]		;
;if time_double(time) gt time_double('2015-02-22/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,5.0]		;
if time_double(time) gt time_double('2015-02-22/00:00') and kk3_anode then kk3 = [5.8,5.3,5.7,5.2]		;**sta o2+ good, lpw fp 2 even orbits, sza=96, alt=157, checked 20241113

if time_double(time) gt time_double('2015-02-24/00:00') and kk3_anode then kk3 = [5.8,5.2,5.7,5.0]		;**sta o2+ good, lpw fp 2 even orbits, sza=?, alt=?, checked 20241113

if time_double(time) gt time_double('2015-02-26/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,4.8]		;**sta o2+ good, lpw fp 2 even orbits, sza=?, alt=?, checked 20241113

if time_double(time) gt time_double('2015-02-28/00:00') and kk3_anode then kk3 = [5.8,5.0,5.7,4.6]		;**sta o2+ good, lpw fp 2 even orbits, sza=87, alt=154, checked 20241113

;if time_double(time) gt time_double('2015-03-01/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,4.6]		;
;if time_double(time) gt time_double('2015-03-01/00:00') and kk3_anode then kk3 = [5.5,4.8,5.4,4.3]		;
if time_double(time) gt time_double('2015-03-01/00:00') and kk3_anode then kk3 = [5.6,4.9,5.5,4.4]		;**sta o2+ good, lpw fp even orbits, sza=85, alt=163, checked 20241104,20241112, 

if time_double(time) gt time_double('2015-03-03/00:00') and kk3_anode then kk3 = [5.4,4.7,5.3,4.2]		;**sta o2+ ok, 1 lpw fp, sza=83, alt=162, checked 20241113, 

;if time_double(time) gt time_double('2015-03-05/00:00') and kk3_anode then kk3 = [5.5,4.8,5.4,4.3]		;
;if time_double(time) gt time_double('2015-03-05/00:00') and kk3_anode then kk3 = [5.2,4.5,5.1,4.0]		;
if time_double(time) gt time_double('2015-03-05/00:00') and kk3_anode then kk3 = [5.3,4.6,5.2,4.1]		;**sta o2+ good, lpw fp even orbits, sza=78, alt=161, checked 20241113, 

if time_double(time) gt time_double('2015-03-08/00:00') and kk3_anode then kk3 = [5.2,4.5,5.1,4.0]		;**sta o2+ good, lpw fp even orbits, sza=73, alt=159, checked 20241113,

	; 20150310	flyY  scenario 2

;if time_double(time) gt time_double('2015-03-11/00:00') and kk3_anode then kk3 = [5.4,4.7,5.3,4.2]		;
if time_double(time) gt time_double('2015-03-11/00:00') and kk3_anode then kk3 = [5.2,4.5,5.1,4.0]		;**sta o2+ good, lpw fp, sza=69, alt=157, checked 20241113, 2 ngims

;if time_double(time) gt time_double('2015-03-15/00:00') and kk3_anode then kk3 = [5.8,5.1,5.7,4.6]		;
;if time_double(time) gt time_double('2015-03-15/00:00') and kk3_anode then kk3 = [5.5,4.8,5.4,4.3]		;
if time_double(time) gt time_double('2015-03-15/00:00') and kk3_anode then kk3 = [5.3,4.6,5.2,4.1]		;**sta o2+ good, lpw fp, sza=62, alt=174, checked 20241104,20241112, 3 ngims

if time_double(time) gt time_double('2015-03-19/00:00') and kk3_anode then kk3 = [5.3,4.7,5.2,4.3]		;
if time_double(time) gt time_double('2015-03-19/00:00') and kk3_anode then kk3 = [5.3,4.6,5.2,4.2]		;**sta o2+ good, lpw fp, FlyY/SunV, sza=56, alt=173, checked 20241114,

if time_double(time) gt time_double('2015-03-20/00:00') and kk3_anode then kk3 = [5.3,4.7,5.2,4.3]		;**sta o2+ good, lpw fp, sza=54, alt=172, checked 20241114,

if time_double(time) gt time_double('2015-03-23/00:00') and kk3_anode then kk3 = [5.3,4.6,5.2,4.1]		;
if time_double(time) gt time_double('2015-03-23/00:00') and kk3_anode then kk3 = [5.3,4.8,5.2,4.4]		;**sta o2+ good, lpw fp, FlyY/SunV, sza=50, alt=171, checked 20241112, 3 ngims on SunV but kk too large 

	; 20150324-26 	STATIC blasted, not pointed at periapsis, mech attenuator off, pickup or protect mode

if time_double(time) gt time_double('2015-03-27/00:00') and kk3_anode then kk3 = [5.5,5.2,5.4,4.6]		;**sta o2+ good, lpw fp, sza=42, alt=169, checked 20241114, 

	; 20150328	STATIC protect mode with mech open at periapsis on contact orbit

;if time_double(time) gt time_double('2015-03-29/00:00') and kk3_anode then kk3 = [5.3,4.6,5.2,4.1]		;
;if time_double(time) gt time_double('2015-03-29/00:00') and kk3_anode then kk3 = [5.6,4.9,5.5,4.6]		;
;if time_double(time) gt time_double('2015-03-29/00:00') and kk3_anode then kk3 = [5.4,5.1,5.3,4.6]		;
if time_double(time) gt time_double('2015-03-29/00:00') and kk3_anode then kk3 = [5.5,5.2,5.4,4.6]		;**sta o2+ good, lpw fp, sza=40, alt=177, checked 20241104,20241111,20241114, last fp fit bad

if time_double(time) gt time_double('2015-03-30/00:00') and kk3_anode then kk3 = [5.7,5.4,5.6,4.8]		;**sta o2+ ok, lpw fp, sza=37, alt=177, checked 20241114, 

;if time_double(time) gt time_double('2015-03-31/00:00') and kk3_anode then kk3 = [5.3,4.6,5.2,4.1]		;
;if time_double(time) gt time_double('2015-03-31/00:00') and kk3_anode then kk3 = [5.5,5.2,5.4,4.6]		;
if time_double(time) gt time_double('2015-03-31/00:00') and kk3_anode then kk3 = [5.7,5.4,5.6,4.8]		;**sta o2+ ok, lpw fp, sza=37, alt=176, checked 20241111,20241114, 1 ngims

	; 20150331	STATIC protect mode with mech open at periapsis on contact orbit
	; 20150331	scenario 2 low s/c charging prevents accurate kk3 estimate 

if time_double(time) gt time_double('2015-04-02/00:00') and kk3_anode then kk3 = [5.7,5.4,5.6,4.8]		;**sta o2+ poor-scpot to small, lpw waves, sza=33, alt=175, checked 20241114,

	; 20150404 	Maven Safed - no data

	; 20150414 	PFDPU power on
	; 20150414	kk3 estimates no longer work, kk3 is likely ~6-7 and a single attenuation factor is not adequate 

;if time_double(time) gt time_double('2015-04-15/00:00') and kk3_anode then kk3 = [4.6,4.4,4.5,3.8]		;
;if time_double(time) gt time_double('2015-04-15/00:00') and kk3_anode then kk3 = [5.7,5.4,5.6,4.8]		;
if time_double(time) gt time_double('2015-04-15/00:00') and kk3_anode then kk3 = [6.4,6.1,6.3,5.5]		;tbd**sta o2+ bad, lpw calib, checked 202002??, 2 ngims
	...
	; 20150422	kk3 estimates no longer work

;if time_double(time) gt time_double('2015-04-24/00:00') and kk3_anode then kk3 = [4.6,4.4,4.5,3.8]		;
;if time_double(time) gt time_double('2015-04-24/00:00') and kk3_anode then kk3 = [5.7,5.4,5.6,4.8]		;
;if time_double(time) gt time_double('2015-04-24/00:00') and kk3_anode then kk3 = [6.4,6.1,6.3,5.5]		;tbd**sta o2+ bad, lpw calib, checked 20241115, 2 ngims
...
;if time_double(time) gt time_double('2015-07-06/00:00') and kk3_anode then kk3 = [5.6,5.4,5.5,4.8]		;
if time_double(time) gt time_double('2015-07-06/00:00') and kk3_anode then kk3 = [7.2,7.0,7.1,6.4]		;**sta o2+ bad, checked 20241115, 2 ngims

	; 20150707 	start deep dip 3

;if time_double(time) gt time_double('2015-07-12/00:00') and kk3_anode then kk3 = [5.6,5.4,5.5,4.8]		;tbd**sta o2+ ok, lpw calib, checked 20200103, 3 ngims

	; 20150715 	end deep dip 3

if time_double(time) gt time_double('2015-07-16/00:00') and kk3_anode then kk3 = [5.6,5.4,5.5,4.8]		;tbd**sta o2+ ok, checked 20241115, 3 ngims

if time_double(time) gt time_double('2015-07-19/00:00') and kk3_anode then kk3 = [5.3,5.1,5.2,4.5]		;
if time_double(time) gt time_double('2015-07-19/00:00') and kk3_anode then kk3 = [5.5,5.3,5.4,4.7]		;**sta o2+ poor, sza=115, alt=145, checked 20241115, 3 ngims

if time_double(time) gt time_double('2015-07-28/00:00') and kk3_anode then kk3 = [4.8,4.6,4.7,4.0]		;
if time_double(time) gt time_double('2015-07-28/00:00') and kk3_anode then kk3 = [5.3,5.1,5.2,4.5]		;**sta o2+ poor, sza=116, alt=145, checked 20241115, 3 ngims

if time_double(time) gt time_double('2015-07-30/00:00') and kk3_anode then kk3 = [5.3,5.1,5.2,4.5]		;tbd**sta o2+ poor, sza=116, alt=145, checked 20241115, 3 ngims
...
;if time_double(time) gt time_double('2015-08-09/00:00') and kk3_anode then kk3 = [5.0,4.8,4.9,4.2]		;tbd **sta o2+ poor, checked 20241115, 2 ngims
...
if time_double(time) gt time_double('2021-12-04/00:00') and kk3_anode then kk3 = [3.4,3.0,3.4,2.8]		;**sta o2+ poor, att=0-1, sza=138, alt=181, scpot=<-1V, checked 20220523
...
if time_double(time) gt time_double('2021-12-21/00:00') and kk3_anode then kk3 = [3.4,3.0,3.4,2.8]		;**sta o2+ ok, att=1-2, sza=110, alt=182, scpot=<-1V, checked 20240523
...
if time_double(time) gt time_double('2022-02-20/00:00') and kk3_anode then kk3 = [3.5,3.1,3.5,3.1]		;tbd fails to load **sta o2+ ok, sza=?, alt=?, scpot=-2V, checked 2022??
...
if time_double(time) gt time_double('2022-05-26/00:00') and kk3_anode then kk3 = [3.3,3.0,3.3,3.0]		;**sta o2+ poor, only last two periapsis, checked 20240522
...
if time_double(time) gt time_double('2023-07-26/00:00') and kk3_anode then kk3 = [3.5,3.3,3.5,3.2]		;**sta o2+ good, sza=73, alt=198, scpot=-1-2.3V, flyY/flyZ checked 20230806 
	...
	; 20230821-20230831  STATIC HV trip off - no STATIC data, mech att open most orbits
...
if time_double(time) gt time_double('2024-01-15/00:00') and kk3_anode then kk3 = [3.7,3.5,3.7,3.4]		;**sta o2+ good, sza=19, alt=196, scpot=-2.5V, checked 20240501 
	...
	; 20240118-20240314  fly(+Z) or Sun-Velocity s/c charging cross calibration not possible
...
if time_double(time) gt time_double('2024-02-08/00:00') and kk3_anode then kk3 = [3.5,3.3,3.5,3.2]		;assume linear in time variation for kk3 
if time_double(time) gt time_double('2024-02-19/00:00') and kk3_anode then kk3 = [3.4,3.2,3.4,3.1]		;assume linear in time variation for kk3 
if time_double(time) gt time_double('2024-03-03/00:00') and kk3_anode then kk3 = [3.3,3.1,3.3,3.0]		;assume linear in time variation for kk3 
...
if time_double(time) gt time_double('2024-03-21/00:00') and kk3_anode then kk3 = [3.2,3.0,3.2,2.9]		;**sta o2+ poor, sza=115, alt=236, scpot=-1-3V, checked 20240501
	...
	; 20240404 STATIC placed in Scan mode, no APP pointing, mech att open
	; 20240411 STATIC returns to Science mode, nominal APP pointing
...
if time_double(time) gt time_double('2024-05-08/00:00') and kk3_anode then kk3 = [3.2,3.0,3.2,2.9]		;**sta o2+ good, sza=73, alt=222, scpot=<-1V, checked 20240520 

if time_double(time) gt time_double('2024-05-15/00:00') and kk3_anode then kk3 = [3.2,3.0,3.2,2.9]		;**sta o2+ good, sza=73, alt=222, scpot=<-1V, checked 20240520 

if time_double(time) gt time_double('2024-05-15/00:00') and kk3_anode then kk3 = [3.2,3.0,3.2,2.9]		;**sta o2+ good, sza=73, alt=222, scpot=<-1V, checked 20240520 

if time_double(time) gt time_double('2024-05-22/00:00') and kk3_anode then kk3 = [3.2,3.1,3.2,3.0]		;assume linear in time variation for kk3, NGIMS partly blocked - no cross-calibration 

	; 20240523 scenario 4b -Zup30  NGIMS partly blocked

	; 20240530 scenario 2b -Zup45  NGIMS partly blocked

if time_double(time) gt time_double('2024-05-29/00:00') and kk3_anode then kk3 = [3.3,3.2,3.2,3.1]		;assume linear in time variation for kk3, NGIMS partly blocked - no cross-calibration  
if time_double(time) gt time_double('2024-06-05/00:00') and kk3_anode then kk3 = [3.4,3.3,3.3,3.2]		;assume linear in time variation for kk3, NGIMS partly blocked - no cross-calibration  

	; 20240612 end scenario 2b -Zup45  NGIMS partly blocked

;if time_double(time) gt time_double('2024-06-12/00:00') and kk3_anode then kk3 = [3.2,3.0,3.2,2.9]		; 
;if time_double(time) gt time_double('2024-06-12/00:00') and kk3_anode then kk3 = [3.4,3.3,3.3,3.2]		; 
if time_double(time) gt time_double('2024-06-12/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ good, sza=41, alt=203, scpot=-1V, checked 20240711, inbound pointing error last two orbits

;if time_double(time) gt time_double('2024-06-20/00:00') and kk3_anode then kk3 = [3.2,3.0,3.2,2.9]		; 
;if time_double(time) gt time_double('2024-06-20/00:00') and kk3_anode then kk3 = [3.7,3.5,3.7,3.4]		; 
if time_double(time) gt time_double('2024-06-20/00:00') and kk3_anode then kk3 = [3.6,3.5,3.5,3.4]		;**sta o2+ good, sza=44, alt=198, scpot=-1V&-3V, checked 20240711, inbound pointing error first few orbits 

if time_double(time) gt time_double('2024-06-28/00:00') and kk3_anode then kk3 = [3.6,3.5,3.5,3.4]		;**sta o2+ good, sza=51, alt=193, scpot=-2.7V, checked 20240711 

if time_double(time) gt time_double('2024-07-05/00:00') and kk3_anode then kk3 = [3.6,3.5,3.5,3.4]		; tbd

;if time_double(time) gt time_double('2024-07-12/00:00') and kk3_anode then kk3 = [3.6,3.5,3.5,3.4]		;
;if time_double(time) gt time_double('2024-07-12/00:00') and kk3_anode then kk3 = [3.4,3.3,3.3,3.2]		;
;if time_double(time) gt time_double('2024-07-12/00:00') and kk3_anode then kk3 = [3.6,3.5,3.5,3.4]		;
if time_double(time) gt time_double('2024-07-12/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ good, lpw fp, sza=68, alt=188, scpot=<-1V,-3V, checked 20240715, flyY/flyY-twist, 

if time_double(time) gt time_double('2024-07-14/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ good, lpw fp, sza=66, alt=188, scpot=<-1V,-3V, checked 20240717, flyY/flyY-twist, 

;if time_double(time) gt time_double('2024-07-15/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;tbd **sta o2+ good, 3 fly-Z, sza=66, alt=188, scpot=<-1V,-3V, checked 202407??, flyY/fly(-Z), s

	; 20240718 begin scenario 2c bad ram pointing "desattitude" for 4 weeks, APP ram pointing only good to 3 deg

;if time_double(time) gt time_double('2024-07-28/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;tbd **sta o2+ good, lpw fp, sza=66, alt=188, scpot=<-1V,-3V, checked 202407??, flyY/fly(-Z), s

;if time_double(time) gt time_double('2024-08-02/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		; one lpw-fp
;if time_double(time) gt time_double('2024-08-02/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		; 
;if time_double(time) gt time_double('2024-08-02/00:00') and kk3_anode then kk3 = [4.3,3.9,4.2,3.8]		;??? **sta o2+ good, sza=93, alt=184, scpot=-2-2.5V, checked 20241219, 

	; 20240815 end scenario 2c bad ram pointing "desattitude" for 4 weeks, APP ram pointing only good to 3 deg
	; 20240815 start scenario 2 flyY

if time_double(time) gt time_double('2024-08-16/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		;**sta o2+ ok, sza=101, alt=183, scpot=-1-2.5V, checked 20241219, 

	; 20240822 start scenario 3 sun-vel
if time_double(time) gt time_double('2024-08-23/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		;**sta o2+ ok, sza=100, alt=183, scpot=-1V, checked 20241219, 

if time_double(time) gt time_double('2024-08-28/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		;**sta o2+ ok, sza=99, alt=183, scpot=-1V, checked 20241219, 

	; 20240829 begin scenario 2b -Zup35 NGIMS partly blocked
	; 20240912 end scenario 2b -Zup35 NGIMS partly blocked
	; 20240912 start scenario 3 sun-vel

;if time_double(time) gt time_double('2024-09-17/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		; 
if time_double(time) gt time_double('2024-09-17/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		;**sta o2+ good, sza=82, alt=183, scpot=<-1V, checked 20241218, 

	; 20240919 begin scenario 2b/4b -Zup30 NGIMS may be partly blocked

;if time_double(time) gt time_double('2024-10-01/00:00') and kk3_anode then kk3 = [3.8,3.4,3.7,3.3]		;
if time_double(time) gt time_double('2024-10-01/00:00') and kk3_anode then kk3 = [3.5,3.1,3.4,3.0]		; 
if time_double(time) gt time_double('2024-10-01/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;**sta o2+ good, sza=64, alt=182, scpot=<-1V, checked 20241219, lpw-fp too high for single orbit 

	; 20241017 end   scenario 2b -Zup30  NGIMS may be partly blocked

	; 20241018-20241024 scenario 2b -Zup45  NGIMS mostly blocked

if time_double(time) gt time_double('2024-10-25/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ good, sza=45, alt=181, scpot=<-2-3V, checked 20241218, 

if time_double(time) gt time_double('2024-10-29/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ good, sza=45, alt=181, scpot=-2-2.6V, checked 20250227 

if time_double(time) gt time_double('2024-11-01/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ ok, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist, 

if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;
if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.8,3.5,3.7,3.5]		; this gave better agreement with NGIMS, but too high values for fp
if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.6,3.3,3.5,3.3]		; first guess was not enough lower
if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.1,2.8,3.0,2.8]		;testing**sta o2+ screwy???, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist), 
if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.1]		;**sta o2+ screwy???, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist), 
if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ screwy???, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist), 
if time_double(time) gt time_double('2024-11-02/00:00') and kk3_anode then kk3 = [3.7,3.4,3.7,3.3]		;**sta o2+ screwy???, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist), 

	; 20241102 is very strange - can't get STATIC or NGIMS or LPW to agree on even/odd orbits to accuracy previously obtained - in addition, ngims sensitivity may have decreased by ~10%
	; If STATIC is the cause of this problem, then it must be a small ~0.5eV energy offset. However, HV offset calib shows no shift
	; This could be a general change in STATIC ESA surface properties related to off-pointing 20240815-20240912 and enhanced exposure to atomic oxygen
	; However further testing with flyY/flyZ for April 11-22 suggests this is just a new small non-linearity not eliminated by kk3 and not the result of an en_offset. 

;if time_double(time) gt time_double('2024-11-03/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.1]		;
if time_double(time) gt time_double('2024-11-03/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;**sta o2+ good, lpw fp, sza=66, alt=188, scpot=-.3V,-3V, checked 20241118, flyY/flyYtwist), 
if time_double(time) gt time_double('2024-11-03/00:00') and kk3_anode then kk3 = [4.0,3.9,3.9,3.8]		;test w/ en_offset=0.3**sta o2+ screwy???, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist), 
if time_double(time) gt time_double('2024-11-03/00:00') and kk3_anode then kk3 = [4.3,4.1,4.2,4.1]		;test w/ en_offset=0.3**sta o2+ screwy???, lpw fp, sza=47, alt=181, scpot=<-1V,>-1V, checked 20241108, flyY/flyYtwist), 
if time_double(time) gt time_double('2024-11-03/00:00') and kk3_anode then kk3 = [3.5,3.4,3.4,3.3]		;test w/ en_offset=-0.2**sta o2+ good, lpw fp, sza=66, alt=188, scpot=-.3V,-3V, checked 20241118, flyY/flyYtwist), 



;if time_double(time) gt time_double('2024-11-09/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.1]		;
if time_double(time) gt time_double('2024-11-09/00:00') and kk3_anode then kk3 = [3.5,3.3,3.4,3.2]		;**sta o2+ good, sza=52, alt=183, scpot=-.5-2.5V, checked 20241220 

if time_double(time) gt time_double('2024-11-24/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.1]		;**sta o2+ good, sza=71, alt=187, scpot=-1-3V, checked 20241219 

if time_double(time) gt time_double('2024-12-09/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.1]		;**sta o2+ good, sza=94, alt=193, scpot=-1-3V, checked 20241218, terminator winds and scpot<-2V may impact ngims 

if time_double(time) gt time_double('2024-12-12/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.2]		;**sta o2+ ok, sza=99, alt=195, scpot=-.5-2.5V, checked 20250227, terminator winds and scpot<-2V may impact ngims 

if time_double(time) gt time_double('2024-12-14/00:00') and kk3_anode then kk3 = [3.6,3.3,3.5,3.3]		;guess, assume linear change  

if time_double(time) gt time_double('2024-12-15/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;**sta o2+ poor, sza=103, alt=197, att=1, scpot=-0.5-2.5V, checked 20250227 

if time_double(time) gt time_double('2024-12-22/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;**sta o2+ poor, sza=112, alt=202, att=1-2, scpot=-0.3-1V, checked 20250227 

;if time_double(time) gt time_double('2024-12-29/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;tbd **sta o2+ poor, sza=, alt=, att=, scpot=-0.3-1V, checked 20250227 

if time_double(time) gt time_double('2025-01-05/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;**sta o2+ ok, sza=124, alt=211, att=0-1, scpot=-1-2V, checked 20250210, terminator 

	; APP pointion off by about 2 degrees

if time_double(time) gt time_double('2025-01-21/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;tbd-guess **sta o2+ ok, sza=124, alt=211, att=0-1, scpot=-1-2V, checked 20250905, terminator 




;if time_double(time) gt time_double('2025-02-07/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.1]		;
if time_double(time) gt time_double('2025-02-07/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;**sta o2+ good, sza=102, alt=230, scpot=-0.6V, checked 20250210, terminator 

;if time_double(time) gt time_double('2025-02-10/00:00') and kk3_anode then kk3 = [3.6,3.3,3.5,3.3]		;
if time_double(time) gt time_double('2025-02-10/00:00') and kk3_anode then kk3 = [3.3,3.0,3.2,3.0]		;tbd-guess**sta o2+ good, off-pointing by 2deg, sza=92, alt=233, scpot=-0.2-.5V, checked 20250226, terminator 

	; APP pointion off by about 2 degrees

;if time_double(time) gt time_double('2025-02-13/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;
if time_double(time) gt time_double('2025-02-13/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.2]		;**sta o2+ good, sza=92, alt=233, scpot=-0.2-.5V, checked 20250226, terminator 

if time_double(time) gt time_double('2025-02-14/00:00') and kk3_anode then kk3 = [3.3,3.0,3.2,3.0]		;**sta o2+ good, sza=90, alt=234, scpot=-0.2-.5V, checked 20250227, significant change between 1st and 2nd orbits 

;if time_double(time) gt time_double('2025-02-15/00:00') and kk3_anode then kk3 = [3.3,3.0,3.2,3.0]		;
if time_double(time) gt time_double('2025-02-15/00:00') and kk3_anode then kk3 = [3.2,2.9,3.1,2.9]		;**sta o2+ good, sza=89, alt=234, att=0-2, scpot=-0.3-1.V, checked 20250226, terminator 

if time_double(time) gt time_double('2025-02-18/00:00') and kk3_anode then kk3 = [3.3,3.0,3.2,3.0]		;
if time_double(time) gt time_double('2025-02-18/00:00') and kk3_anode then kk3 = [3.1,2.8,3.0,2.8]		;**sta o2+ good, sza=85, alt=234, scpot=-0.2-.5V, checked 20250226, terminator 

;if time_double(time) gt time_double('2025-02-22/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.4]		;
;if time_double(time) gt time_double('2025-02-22/00:00') and kk3_anode then kk3 = [3.2,2.9,3.1,2.9]		;
if time_double(time) gt time_double('2025-02-22/00:00') and kk3_anode then kk3 = [3.1,2.8,3.0,2.8]		;**sta o2+ good, sza=78, alt=235, scpot=-0.2-.5V, checked 20250904 

if time_double(time) gt time_double('2025-02-25/00:00') and kk3_anode then kk3 = [3.2,2.9,3.1,2.8]		;tbd-guess **sta o2+ tbd, sza=?, alt=?, scpot=-0.2-.5V, checked 20250? 

if time_double(time) gt time_double('2025-02-28/00:00') and kk3_anode then kk3 = [3.3,3.0,3.2,2.9]		;**sta o2+ ok, att=0-2, sza=67, alt=235, scpot=-0.2-1.0V, checked 20250904 

;if time_double(time) gt time_double('2025-03-06/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.0]		;
if time_double(time) gt time_double('2025-03-06/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.0]		;**sta o2+ good, att=0-2, sza=58, alt=235, scpot=-0.5-1.0V, checked 20250904,  

if time_double(time) gt time_double('2025-03-09/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.0]		;**sta o2+ ok, att=1-2, sza=54, alt=235, scpot=-0.7-1.5V, checked 20250904,

;if time_double(time) gt time_double('2025-03-12/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,3.0]		;  
;if time_double(time) gt time_double('2025-03-12/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;
if time_double(time) gt time_double('2025-03-12/00:00') and kk3_anode then kk3 = [3.6,3.3,3.5,3.1]		;**sta o2+ good, sza=51, alt=234, scpot=-0.5-1.0V, checked 20250904,  
 
	; 20250313-0320 No calibration possible, scenario 2b -Zup45  NGIMS blocked

if time_double(time) gt time_double('2025-03-26/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;**sta o2+ good, sza=41, alt=229,  scpot=-1.5-2.5V, checked 20250904 

	; 20250411-20250425 two weeks of flyY/flyY-twist at high altitude for NGIMS-STATIC cross calibration to check for changes in HV sweep offset due to ESA surface changes observed 20241102

;if time_double(time) gt time_double('2025-04-11/00:00') and kk3_anode then kk3 = [3.1,2.8,3.0,2.8]		; flyY/flyY-twist
if time_double(time) gt time_double('2025-04-11/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;**sta o2+ good, flyY/flyY-twist, sza=53, alt=219,  scpot=-1.-2.3V, checked 20250416 

;if time_double(time) gt time_double('2025-04-16/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;tbd **sta o2+ tbd, flyY/flyY-twist, sza=?, alt=?,  scpot=-1.-2.3V, checked 20250? 

if time_double(time) gt time_double('2025-04-21/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;**sta o2+ good, flyY/flyY-twist, sza=68, alt=212,  scpot=-1.-2.3V, checked 20250827 

if time_double(time) gt time_double('2025-04-22/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;**sta o2+ ok-varies over day, flyY/flyY-twist, sza=70, alt=212,  scpot=-1.-2.3V, checked 20250827 

;if time_double(time) gt time_double('2025-05-01/00:00') and kk3_anode then kk3 = [3.7,3.4,3.6,3.2]		;
if time_double(time) gt time_double('2025-05-01/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.0]		;**sta o2+ good, sza=86, alt=205, att=0-2 scpot=-0.5-1V, checked 20250826 

if time_double(time) gt time_double('2025-05-05/00:00') and kk3_anode then kk3 = [3.6,3.2,3.5,3.0]		;
if time_double(time) gt time_double('2025-05-05/00:00') and kk3_anode then kk3 = [3.4,3.1,3.3,2.9]		;**sta o2+ good, sza=92, alt=204, att=0-3, scpot=-0.5-1.5V, checked 20250905 

if time_double(time) gt time_double('2025-05-07/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.0]		;**sta o2+ good, sza=97, alt=202, att=0-2, scpot=-0.5-1.5V, checked 20250905 
if time_double(time) gt time_double('2025-05-08/00:00') and kk3_anode then kk3 = [3.7,3.3,3.6,3.1]		;**sta o2+ good, sza=98, alt=202, att=0-2, scpot=-0.5-1.5V, checked 20250905 


;if time_double(time) gt time_double('2025-05-11/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.0]		;
if time_double(time) gt time_double('2025-05-11/00:00') and kk3_anode then kk3 = [3.7,3.3,3.6,3.1]		;**sta o2+ ok, sza=103, alt=200, att=0-2 scpot=-0.5-2.5V, checked 20250827

if time_double(time) gt time_double('2025-05-18/00:00') and kk3_anode then kk3 = [3.8,3.3,3.7,3.1]		;**sta o2+ poor, sza=118, alt=196, att=0-1 scpot=-0.3-3V, checked 20250905 

;if time_double(time) gt time_double('2025-05-22/00:00') and kk3_anode then kk3 = [3.5,3.2,3.4,3.0]		;
if time_double(time) gt time_double('2025-05-22/00:00') and kk3_anode then kk3 = [3.9,3.3,3.8,3.2]		;**sta o2+ poor, sza=125, alt=193, att=1-2 scpot=-0.5-2.5V, checked 20250827 

if time_double(time) gt time_double('2025-05-28/00:00') and kk3_anode then kk3 = [4.0,3.4,3.9,3.3]		;guess **sta o2+ tbd?, sza=?, alt=?, att=? scpot=-0.?V, checked 20250 

if time_double(time) gt time_double('2025-05-31/00:00') and kk3_anode then kk3 = [4.1,3.4,4.0,3.4]		;guess **sta o2+ tbd?, sza=?, alt=?, att=? scpot=-0.?V, checked 20250

;if time_double(time) gt time_double('2025-06-03/00:00') and kk3_anode then kk3 = [4.5,3.8,4.4,3.8]		;
if time_double(time) gt time_double('2025-06-03/00:00') and kk3_anode then kk3 = [4.2,3.5,4.1,3.5]		;**sta o2+ poor, sza=147, alt=188, att=0,1, scpot=-.5-1.3V, checked 20250826 

if time_double(time) gt time_double('2025-06-11/00:00') and kk3_anode then kk3 = [4.3,3.6,4.2,3.6]		;guess 

if time_double(time) gt time_double('2025-06-19/00:00') and kk3_anode then kk3 = [4.4,3.7,4.3,3.7]		;**sta o2+ poor, sza=175, alt=183, att=0,1, scpot=-.5-1.3V, checked 20250827 

if time_double(time) gt time_double('2025-07-04/00:00') and kk3_anode then kk3 = [4.5,3.8,4.4,3.8]		;**sta o2+ poor, sza=152, alt=182, att=0,1, scpot=-.5-1.0V, checked 20250826 

;if time_double(time) gt time_double('2025-07-22/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		; 
;if time_double(time) gt time_double('2025-07-22/00:00') and kk3_anode then kk3 = [4.3,4.0,4.2,3.8]		; 
if time_double(time) gt time_double('2025-07-22/00:00') and kk3_anode then kk3 = [4.5,3.8,4.4,3.8]		;**sta o2+ ok, sza=124, alt=181, att=0-2, scpot=-.5-1.5V, checked 20250826 

;if time_double(time) gt time_double('2025-07-26/00:00') and kk3_anode then kk3 = [4.4,3.7,4.3,3.7]		;tbd **sta o2+ tbd, sza=?, alt=?,  scpot=-?2.3V, checked 20250826 
;if time_double(time) gt time_double('2025-07-27/00:00') and kk3_anode then kk3 = [4.4,3.7,4.3,3.7]		;tbd **sta o2+ tbd, sza=?, alt=?,  scpot=-?2.3V, checked 20250826 

;if time_double(time) gt time_double('2025-07-31/00:00') and kk3_anode then kk3 = [4.5,3.8,4.4,3.8]		;
if time_double(time) gt time_double('2025-07-31/00:00') and kk3_anode then kk3 = [4.4,3.7,4.3,3.7]		;**sta o2+ ok, sza=112, alt=181, att=0-2, scpot=-0.5-1.5V, checked 20250826 

if time_double(time) gt time_double('2025-08-05/00:00') and kk3_anode then kk3 = [4.3,3.7,4.2,3.6]		;tbd-guess **sta o2+ tbd, sza=?, alt=?, att=1-3, scpot=-1-2.5V, checked 20250? 

if time_double(time) gt time_double('2025-08-09/00:00') and kk3_anode then kk3 = [4.2,3.7,4.1,3.6]		;**sta o2+ 1-ngims, sza=102, alt=181, att=1-3, scpot=-0.5-1.5V, checked 20250827 

if time_double(time) gt time_double('2025-08-11/00:00') and kk3_anode then kk3 = [4.2,3.7,4.1,3.6]		;**sta o2+ good, sza=100, alt=181, att=1-3, scpot=-1-2.5V, checked 20250827 

if time_double(time) gt time_double('2025-08-14/00:00') and kk3_anode then kk3 = [4.1,3.7,4.0,3.6]		;tbd-guess **sta o2+ tbd, sza=?, alt=?, att=1-3, scpot=-1-2.5V, checked 20250?

if time_double(time) gt time_double('2025-08-17/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+ good, sza=95, alt=182, att=1-3, scpot=-2.8V, checked 20250825 

if time_double(time) gt time_double('2025-08-21/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+ good, sza=93, alt=181, att=1-3, scpot=-1-2.7V, checked 20250829 


if time_double(time) gt time_double('2025-08-29/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+ good, sza=91, alt=182, att=2-3, scpot=-2.5-3V, checked 20251106 
if time_double(time) gt time_double('2025-09-10/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+ good, sza=95, alt=181, att=2-3, scpot=-2-3.5V, checked 20251106 
if time_double(time) gt time_double('2025-09-17/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+   ok, sza=101, alt=182, att=1-2, scpot=-1-2V, checked 20251106 
if time_double(time) gt time_double('2025-09-25/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+   ok, sza=110, alt=182, att=0-2, scpot=-1-2V, checked 20251107 
if time_double(time) gt time_double('2025-10-08/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+   ok, sza=128, alt=183, att=0-1, scpot=-0.1-2V, checked 20251107 
if time_double(time) gt time_double('2025-10-14/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+  bad, sza=138, alt=185, att=1, scpot=-.3-1.5V, checked 20251106 
if time_double(time) gt time_double('2025-10-20/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+   ok, sza=148, alt=185, att=0-1, scpot=-0-1V, checked 20251107 
if time_double(time) gt time_double('2025-10-30/00:00') and kk3_anode then kk3 = [4.0,3.7,3.9,3.5]		;**sta o2+   ok, sza=164, alt=190, att=0-1, scpot=-0.5-2V, checked 20251107 
