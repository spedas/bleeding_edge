...
FUNCTION mvn_sta_get_kk3,time,noplot=noplot
  ...
  ; 20241102 is very strange - can't get STATIC or NGIMS or LPW to agree on even/odd orbits - ngims sensitivity may have decreased by ~10%
  ; If STATIC is the cause of this problem, then it must be a small ~0.5eV energy offset. HV offset calib shows no shift
  ...
  if time_double(time) gt time_double('2025-02-10/00:00') and kk3_anode then kk3 = [3.6,3.3,3.5,3.3]    ;tbd guess**sta o2+ good, sza=92, alt=233, scpot=-0.2-.5V, checked 20250226, terminator
  ...
  if time_double(time) gt time_double('2025-02-22/00:00') and kk3_anode then kk3 = [3.1,2.8,3.0,2.8]    ;**sta o2+ good, sza=78, alt=235, scpot=-0.2-.5V, checked 20250226, terminator
  ...
  if time_double(time) gt time_double('2025-05-05/00:00') and kk3_anode then kk3 = [3.6,3.2,3.5,3.0]    ;guess **sta o2+ tbd, sza=?, alt=?, att=? scpot=-0.?V, checked 20250?
  ...
  if time_double(time) gt time_double('2025-05-16/00:00') and kk3_anode then kk3 = [3.8,3.3,3.7,3.1]    ;guess **sta o2+ tbd, sza=?, alt=?, att=? scpot=-0.?V, checked 20250827
  ;if time_double(time) gt time_double('2025-05-18/00:00') and kk3_anode then kk3 = [3.8,3.3,3.7,3.1]   ;guess **sta o2+ tbd, sza=?, alt=?, att=? scpot=-0.?V, checked 20250827
  ...
  if time_double(time) gt time_double('2025-05-28/00:00') and kk3_anode then kk3 = [4.0,3.4,3.9,3.3]    ;guess **sta o2+ tbd, sza=?, alt=?, att=? scpot=-0.?V, checked 20250827

  if time_double(time) gt time_double('2025-05-31/00:00') and kk3_anode then kk3 = [4.1,3.4,4.0,3.4]    ;guess **sta o2+ tbd, sza=?, alt=?, att=? scpot=-0.?V, checked 20250827
