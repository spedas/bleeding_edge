...
;-
Function mvn_sta_l2dat_struct, apid
...
;Define the common blocks
  ...
  aa = strlowcase(strcompress(apid,/remove_all))

  bb = 'cmn_dat = mvn_'+aa[0]+'_dat'

  cc = execute(bb)

  If(cc Gt 0 && is_struct(cmn_dat)) Then Return, cmn_dat Else Return, -1
