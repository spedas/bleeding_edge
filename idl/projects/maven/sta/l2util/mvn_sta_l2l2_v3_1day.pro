...
;the day.
;CALLING SEQUENCE:
; .run mvn_sta_l2l2_v3_1day
;INPUT:
;start_time, end_time are input from files
;mvn_sta_l2l2_v3_1day_start_time.txt and
;mvn_sta_l2l2_v3_1day_end_time.txt.
;OUTPUT:
; Maven STA L2 files
;HISTORY:
; 2025-09-10, jimm@ssl.berkeley.edu
;-
this_file = 'mvn_sta_l2l2_v3_1day'
...
mvn_call_sta_l2l2, days_in = time_string(tstart), temp_dir = './', /use_l2_files, $
