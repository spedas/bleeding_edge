...
;the day. This initializes the calculation.
;CALLING SEQUENCE:
; .run mvn_sta_v3_all_1day_init
;INPUT:
;start_time, end_time are input from files
;mvn_sta_v3_all_1day_start_time.txt and
;mvn_sta_v3_all_1day_end_time.txt.
;OUTPUT:
; Maven STA L2 files
;HISTORY:
; 2025-09-10, jimm@ssl.berkeley.edu
;-
this_file = 'mvn_sta_v3_all_1day'
...
;or for all the days in advance
one_day = 86400.0d0
