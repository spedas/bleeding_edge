...
function swfo_stis_sci_l0b,getall=getall,prev_l0b_dat=output,sci_dat=sci_dat,nse_dat=nse_dat,hkp_dat=hkp_dat, sc100_dat=sc100_dat,sc110_dat=sc110_dat, playback=playback  ;,format=format,reset=reset,cal=cal
  ...
  if keyword_set(blank_l0b) then return,output   ;l0b
