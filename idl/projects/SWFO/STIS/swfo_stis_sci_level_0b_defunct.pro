;
; Older version of Level 0b data structure generation, superceded.
; $LastChangedBy: rjolitz $
; $LastChangedDate: 2025-10-18 18:56:24 -0700 (Sat, 18 Oct 2025) $
; $LastChangedRevision: 33772 $
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/SWFO/STIS/swfo_stis_sci_level_0b_defunct.pro $





function swfo_stis_sci_level_0b_defunct,sci_dat,nse_dat,hkp_dat, sc100_dat=sc100_dat,sc110_dat=sc110_dat, playback=playback  ;,format=format,reset=reset,cal=cal
