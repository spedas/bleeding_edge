pro swfo_mag_decom,magda,result_da,clear=clear


  if ~isa(result_da,'dynamicarray') then begin
    result_da = dynamicarray(name='mag_hr')
  endif

  if keyword_set(clear) then result_da.size =0
