      ...
      for tint= tints[0],tints[1]+1 do begin
        ...
        if keyword_set(make_l0b) then begin
          ...
          foreach type,types do begin
            ...
            filetime = max(fi.mtime)
            dynarray.dict.filenames = files
            dynarray.dict.filetime = filetime
            l0a_filetime = max([l0a_filetime,filetime])
          ...
          if l0b_filetime lt l0a_filetime then begin
            ...
            foreach type,types do begin
              ...
              dynarray.size = 0
              da = swfo_ncdf_read(filenames = dynarray.dict.filenames,dynarray=dynarray)
              dynarray.trim
              dynarray.sort,/uniq
