...
print, 'Tilt (expected -25.531946614204912) : ', tilt
...
print, 'Retraced north foot point (should closely match initial north foot point from first call): ',ret_foot_x, ret_foot_y, ret_foot_z
tr_sp_np = trgsm_out
