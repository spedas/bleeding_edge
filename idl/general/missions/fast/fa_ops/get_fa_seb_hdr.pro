...
FUNCTION get_fa_seb_hdr, inputTime, INDEX=idx

   dat = get_ts_1p_from_sdt ('Sesa_Cmb_Burst_Packet_Hdr', 2001, inputTime, $
                             INDEX=idx) 
   ...
   ENDIF ELSE BEGIN
      ...
      data_name = 'Sesa_Cmb_Burst_Packet_Hdr'
      units_name = 'Raw'
      values_procedure = 'eiesa_unpack_hdr'
      inputTime = dat.time 
      bytes = dat.comp1
