...
FUNCTION Get_fa_tbo_3d, inputTime, START=start, EN=en, ADVANCE=advance,  $
      ...
      index = find_handle('tbo_time',tagname)
      IF index EQ 0 THEN BEGIN
	 dat = get_fa_tbo(0, /st)
	 dat = get_fa_tbo(dat.time, /ad)
	 t = dat.time
	 n = 0
      ENDIF ELSE BEGIN
...
;      eff = FLTARR(dat0.nenergy, nbins)
	...
	ENDIF
      ...
      store_data, 'tbo_time', data = datstr
