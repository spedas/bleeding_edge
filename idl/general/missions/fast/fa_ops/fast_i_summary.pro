...
;-
pro fast_i_summary,BW=bw,k0=k0
...
; Ion differential energy flux - energy spectrograms
	...
	get_en_spec,"fa_ies_sp",units='eflux',name='ion_0',angle=[330,30],retrace=1
	...
	get_en_spec,"fa_ies_sp",units='eflux',name='ion_90',angle=[40,140],retrace=1
	...
	get_en_spec,"fa_ies_sp",units='eflux',name='ion_180',angle=[150,210],retrace=1
...
; Ion differential energy flux - angle spectrograms
	...
	get_pa_spec,"fa_ies_sp",units='eflux',name='ion_low',energy=[50,1000],retrace=1,/shift90
	...
	get_pa_spec,"fa_ies_sp",units='eflux',name='ion_high',energy=[1000,40000],retrace=1,/shift90
...
; Ion energy flux - line plot
	...
	get_2dt,'je_2d','fa_ies_sp',name='JEi',energy=[20,30000]
	ylim,'JEi',1.e-5,1,1
...
; Ion flux - line plot
	...
	get_2dt,'j_2d','fa_ies_sp',name='Ji',energy=[20,30000]
	ylim,'Ji',1.e5,1.e9,1
