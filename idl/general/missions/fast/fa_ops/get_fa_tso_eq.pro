...
FUNCTION Get_fa_tso_eq, inputTime, START=start, EN=en, ADVANCE=advance,  $
...
;   domega = REPLICATE(0.3005588, nbins)
   ...
   hdr_time = dat.time - (dat.end_time - dat.time)/2.0
   hdr_mag = get_fa_tsop_hdr (hdr_time)		;call previous data header
						;to average the mag-direction
