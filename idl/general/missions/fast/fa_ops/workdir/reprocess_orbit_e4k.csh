...
#Run in /home/jimm/fast_idl2
cd /home/jimm/fast_idl2
...
# Zero-pad orbit to 5 digits
    ...
    echo $orbit
# Check for file , e.g., fa_despun_e4k_l2_19961211093933_01211_v02.cdf
    set pattern = "/disks/data/fast/l2/e4k/*/fa_despun_e4k_l2_*_${orbit}_v02.cdf"
...
# Write file for sdt_batch,
        rm -rf process_orbit_e4k.batch
        set line="BatchJob:  cdftest"
        echo $line > process_orbit_e4k.batch
        ...
        set line="NoPlots:"
        echo $line >> process_orbit_e4k.batch
        set line="IDL: run_process_despin_e4k.pro"
        echo $line >> process_orbit_e4k.batch
        ...
        echo $line >> process_orbit_e4k.batch
        set line="PlotConfigurationFile: Despin4k_NoData_All"
        echo $line >> process_orbit_e4k.batch
#Now call sdt_batch using this file
        sdt_batch process_orbit_e4k.batch
    endif
else
