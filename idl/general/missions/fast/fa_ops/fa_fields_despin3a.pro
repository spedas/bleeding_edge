...
;Conversion values are Meters/1000(V/mV)
  ...
  Endif
;Use tuserdef to get V1, V5,
;  If(is_struct(v4x) && is_struct(v14x)) Then Begin
;     ;'fa_V4_S' is interpolated to the v1-v4 time array
;     v1var = tuserdef(['fa_V1-V4_S','fa_V4_S'], 'qq[0]+qq[1]', out_varname ;= 'fa_V1_S')
;     If(is_String(v1var)) Then Begin
;        dlimit = {spec:0, ystyle:1, $
;                  ytitle:'V1_S(V)'}
;        store_data,'fa_V1_S', dlimit=dlimit
;     Endif
;  Endif Else If(is_struct(v2x) && is_struct(v12x)) Then Begin
;     ;'fa_V2_S' is interpolated to the v1-v4 time array
;     v1var = tuserdef(['fa_V1-V2_S','fa_V2_S'], 'qq[0]+qq[1]', out_varname ;= 'fa_V1_S')
;     If(is_String(v1var)) Then Begin
;        dlimit = {spec:0, ystyle:1, $
;                  ytitle:'fa_V1_S(V)'}
;        store_data,'fa_V1_S', dlimit=dlimit
;     Endif
;  Endif
;  If(is_struct(v8x) && is_struct(v58x)) Then Begin
;     ;'fa_V8_S' is interpolated to the v5-v8 time array
;     v5var = tuserdef(['fa_V5-V8_S','fa_V8_S'], 'qq[0]+qq[1]', out_varname ;= 'fa_V5_S')
;     If(is_String(v5var)) Then Begin
;        dlimit = {spec:0, ystyle:1, $
;                  ytitle:'V5_S(V)'}
;        store_data,'fa_V5_S', dlimit=dlimit
;     Endif
;  Endif
