...
FUNCTION Get_fa_tsa, inputTime, START=start, EN=en, ADVANCE=advance,  $
      ...
      REPEAT BEGIN
          IF NOT first THEN       $
            print, 'get_fa_tsa.pro: Badly formed data.  Getting next sample'
          first = 0
...
;      eff = REPLICATE (1., dat.dimsizes(0))
      mass = 0.0207261                          ; mass eV/(km/sec)^2
      geomfactor = 0.0015
