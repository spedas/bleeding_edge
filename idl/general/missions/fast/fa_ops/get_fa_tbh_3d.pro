...
FUNCTION Get_fa_tbh_3d, inputTime, START=start, EN=en, ADVANCE=advance,  $
      ...
      index = find_handle('tbh_time',tagname)
      IF index EQ 0 THEN BEGIN
	 dat = get_fa_tbh(0, /st)
	 dat = get_fa_tbh(dat.time, /ad)
	 t = dat.time
	 n = 0
      ENDIF ELSE BEGIN
	...
	ENDIF
      ...
      store_data, 'tbh_time', data = datstr
