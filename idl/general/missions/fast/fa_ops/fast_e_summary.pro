...
;-
pro fast_e_summary,BW=bw,k0=k0
...
; Electron differential energy flux - energy spectrograms
	...
	get_en_spec,"fa_ees_sp",units='eflux',name='el_0',angle=[330,30],retrace=1
	options,'el_0','spec',1	
	zlim,'el_0',1e6,1e9,1
	ylim,'el_0',3,40000,1
	...
	get_en_spec,"fa_ees_sp",units='eflux',name='el_90',angle=[60,120],retrace=1
	...
	get_en_spec,"fa_ees_sp",units='eflux',name='el_180',angle=[150,180],retrace=1
...
; Electron differential energy flux - angle spectrograms
	...
	get_pa_spec,"fa_ees_sp",units='eflux',name='el_low',energy=[100,1000],retrace=1,/shift90
	...
	get_pa_spec,"fa_ees_sp",units='eflux',name='el_high',energy=[1000,40000],retrace=1,/shift90
...
; Electron energy flux - line plot
	...
	get_2dt,'je_2d','fa_ees_sp',name='JEe',energy=[25,40000]
	ylim,'JEe',.001,100,1
...
; Electron flux - line plot
	...
	get_2dt,'j_2d','fa_ees_sp',name='Je',energy=[25,40000]
