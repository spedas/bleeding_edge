...
pro phasef_save_esvy_despun_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
;---Check data availability.
    ...
    ;phasef_read_esvy_despun, date, probe=probe, errmsg=errmsg, log_file=log_file
...
phasef_save_bias_current_to_file, date, probe=probe, filename=file
end
