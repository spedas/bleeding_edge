...
pro phasef_save_e_hires_uvw_to_file, date, probe=probe, filename=file, errmsg=errmsg, log_file=log_file, saved_vars=new_vars
...
phasef_save_e_hires_uvw_to_file, date, probe=probe, filename=file
end
