...
; $LastChangedDate: 2019-11-20 09:58:49 -0800 (Wed, 20 Nov 2019) $
; $LastChangedRevision: 28045 $
...
;           tinterpol_mxn,rbx+'efw_esvy',rbx+'efw_vsvy',newname=rbx+'efw_esvy'
...
;For spinfit data use the spinfit times. Otherwise use the ephemeris times (once/min)
  ...
  ;--------------------------------------------------
     ...
     if type eq 'spinfit_both_boompairs' then begin
        ...
        tinterpol_mxn,rbx+'efw_esvy_spinfit_12',times,$
              newname=rbx+'efw_esvy_spinfit_12'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_spinfit_12',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_spinfit_12'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_spinfit_edotb_12',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_spinfit_edotb_12'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_12',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_12'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_edotb_12',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_edotb_12'
        ...
        tinterpol_mxn,rbx+'efw_esvy_spinfit_34',times,$
              newname=rbx+'efw_esvy_spinfit_34'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_spinfit_34',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_spinfit_34'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_spinfit_edotb_34',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_spinfit_edotb_34'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_34',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_34'
        ...
        tinterpol_mxn,rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_edotb_34',times,$
              newname=rbx+'efw_esvy_mgse_vxb_removed_coro_removed_spinfit_edotb_34'
  ...
  ;--------------------------------------
   ...
   tinterpol_mxn,rbx+'efw_vsvy',times,newname=rbx+'efw_vsvy_combo'
  ...
  ;Esvy spinfit.
     ...
     rbx+'state_mlt',rbx+'state_mlat',rbx+'state_lshell',rbx+'ME_lstar',$
     rbx+'ME_orbitnumber',rbx+'spinaxis_direction_gse','angles']

     for qq=0,n_elements(varstmp)-1 do tinterpol_mxn,varstmp[i],times,newname=varstmp[i]

;     tinterpol_mxn,rbx+'E_coro_mgse',times,newname=rbx+'E_coro_mgse'
;     tinterpol_mxn,rbx+'vscxb',times,newname='vxb'
;     tinterpol_mxn,rbx+'state_vel_coro_mgse',times,newname=rbx+'state_vel_coro_mgse'
;     tinterpol_mxn,rbx+'state_pos_gse',times,newname=rbx+'state_pos_gse'
;     tinterpol_mxn,rbx+'state_vel_gse',times,newname=rbx+'state_vel_gse'
;     tinterpol_mxn,rbx+'mag_mgse_'+model,times,newname=rbx+'mag_mgse_'+model
;     tinterpol_mxn,rbx+'mag_mgse_t89_dif',times,newname=rbx+'mag_mgse_t89_dif'
;     tinterpol_mxn,rbx+'state_mlt',times,newname=rbx+'state_mlt'
;     tinterpol_mxn,rbx+'state_mlat',times,newname=rbx+'state_mlat'
;     tinterpol_mxn,rbx+'state_lshell',times,newname=rbx+'state_lshell'
;     tinterpol_mxn,rbx+'ME_lstar',times,newname=rbx+'ME_lstar'
;     tinterpol_mxn,rbx+'ME_orbitnumber',times,newname=rbx+'ME_orbitnumber'
;     tinterpol_mxn,rbx+'spinaxis_direction_gse',times,newname=rbx+'spinaxis_direction_gse'
;     tinterpol_mxn,'angles',times,newname='angles'
     ...
     get_data,rbx+'ME_lstar',data=lstar
