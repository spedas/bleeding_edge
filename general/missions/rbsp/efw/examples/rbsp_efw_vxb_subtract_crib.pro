...
;****NOTE: IF YOU DON'T NEED THE FULL 32 S/s RESOLUTION THEN CONSIDER USING rbsp_efw_spinfit_vxb_subtract_crib.pro
;****THE DATA WILL BE AT SPINPERIOD CADENCE BUT WILL BE CLEANER
;
;This uses the 4-sec EMFISIS data in GSE. This is actually superior to the hires GSE
;data b/c it doesn't have spurious data spikes. It works about the same as JBT's method
;of despinning and then spinfitting the EMFISIS quicklook UVW data.
;
;
;
