function spp_swp_thermistor_temp,R,parameter=p,b2252=b2252,L1000=L1000
  ...
  if not keyword_set(p) then begin
     ...
     if keyword_set(B2252) then $
        p={func:'thermistor_temp',note:'YSI (B2252)',R0:2252., $
           T0:24.990713d, t1:-22.808501d, t2:1.5334736d, t3:-0.10485403d, $
           t4:0.0076653446d, t5:-0.00084656440d ,t6:6.1095571d-005}
     if keyword_set(L1000) then $
        p={func:'thermistor_temp',note:'YSI (L1000)',R0:1000.,  $
