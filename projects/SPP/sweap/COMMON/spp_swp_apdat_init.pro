...
pro spp_swp_apdat_init,reset=reset, save_flag = save_flag, $
  ...
  spp_apdat_info,'341'x,name='swem_dig_hkp',routine='spp_swp_swem_dhkp_decom',tname='spp_swem_dhkp_',    save_flag=save_flag,ttags=ttags,rt_flag=rt_flag 
  spp_apdat_info,'342'x,name='swem_mem_dump',routine='spp_generic_decom',tname='spp_swem_crit_',    save_flag=save_flag,ttags=ttags,rt_flag=rt_flag
