...
;function spp_swp_swem_dhkp_struct,buffer
...
if ccsds.pkt_size eq 90 then begin   ; This is old version of software????  not sure of what the packet size should have been for this version
