...
;   IDL> erg_load_pwe_hfa, datalist=datalist
;   IDL> erg_print_version_table, datalist, filename='datalist'
;-

pro erg_print_version_table, filename=filename 
