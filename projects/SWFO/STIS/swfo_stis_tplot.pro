...
pro swfo_stis_tplot,name,add=add,setlim=setlim
  ...
  if keyword_set(setlim) then begin
    ...
    options,'*sci_COUNTS',spec=1,panel_size=7,/no_interp,/zlog  ,zrange=[1,4000.]
    ...
    options,'*DETECTOR_BITS',tplot_routine='bitplot',labels=reverse(['BLR_MODE1','BRL_MODE0','F2','T2','O2','F1','T1','O1']),psyms=1,colors=[0,1,2]
