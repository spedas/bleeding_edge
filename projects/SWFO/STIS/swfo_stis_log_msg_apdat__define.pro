...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/SWFO/STIS/swfo_stis_log_msg_apdat__define.pro $

function swfo_stis_log_msg_apdat::decom,ccsds, source_dict=source_dict     ; ptp_header=ptp_header   ;, apdat=apdat,dlevel=dlevel
...
PRO swfo_stis_log_msg_apdat__define

  void = {swfo_stis_log_msg_apdat, $
