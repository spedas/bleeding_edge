...
;
;-
function cdf_load_vars2, files, varnames=vars, varformat=vars_fmt, $
                         info=info, verbose=verbose, all=all, record=record, $
...
vars=''
info = 0
dprint,dlevel=4,verbose=verbose,'$Id: cdf_load_vars2.pro 21206 2016-05-25 22:16:05Z egrimes $'
