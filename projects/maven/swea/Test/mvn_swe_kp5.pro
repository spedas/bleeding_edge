...
pro mvn_swe_kp5, pans=pans, ddd=ddd, abins=abins, dbins=dbins, obins=obins, $
                mask_sc=mask_sc, mom=mom, l2only=l2only, output_path=output_path, $
                trange=trange, qlevel=qlevel
...
;
; Note: for this test version, disable the LPW/SWE potential
; because it has not yet been updated to filter out anomalous
; SWEA spectra.  Use QLEVEL to filter out anomalous spectra
; from the SWEPOS estimation.

  mvn_scpot, composite=0, lpwpot=0, pospot=1, negpot=0, stapot=0, qlevel=qlevel
...
; Calculate the density and temperature
  ...
  mvn_swe_n1d, mom=mom, pans=more_pans, qlevel=qlevel
