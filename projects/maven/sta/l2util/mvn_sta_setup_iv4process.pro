...
Pro mvn_sta_setup_iv4process, start_date = start_date, $ ;default is 2014-10-06
...
;run as jimm?
  If(getenv('USER') Eq 'jimm') Then Begin
     file_copy, '/home/jimm/themis_sw/projects/maven/sta/l2util/mvn_sta_iv4_1day.pro', '/mydisks/home/maven/jimm/mvn_sta_iv4_1day.pro', /overwrite
     mvn_l2gen_multiprocess_a, 'mvn_sta_iv4_1day', nproc, 0, time_range, '/mydisks/home/maven/jimm/'
  Endif Else Begin
     file_copy, '/home/muser/export_socware/idl_socware/projects/maven/sta/l2util/mvn_sta_iv4_1day.pro', '/mydisks/home/maven/mvn_sta_iv4_1day.pro', /overwrite
     mvn_l2gen_multiprocess_a, 'mvn_sta_iv4_1day', nproc, 0, time_range, '/mydisks/home/maven/'
  Endelse
End
